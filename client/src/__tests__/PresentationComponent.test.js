...
import Presentation from '../components/PresentationComponent.js';

describe('Presentation', () => {
  test('Renders the ', () => {
    const userName='username';
    const drawingsList=[{name:'Invention Name', problem:'Problem name', playerName:'user', url:'images/logo.svg'}];
    const current=0;
    const stage='start';
